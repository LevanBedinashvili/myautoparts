    ...
    <div class="side-app">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> ახალი ქვეკატეგორიის დამატება</li>
            </ol>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-20">
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.sub_add_insert') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" data-parsley-class-handler="#slWrapper2" data-parsley-errors-container="#slErrorContainer2" name="category" data-placeholder="Choose one" required>
                                    ...
                                    @foreach ($cats as $cat)
                                    <option value="{{ $cat->id }}">{{ $cat->name_geo }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
