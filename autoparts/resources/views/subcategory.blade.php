                ...
                @foreach ($subcategory as $item)
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="shop-item mb-20">
                            ...
                            <div class="shop-content text-center">
                                <h3 class="title"><a href="{{ route('product', $item->id) }}">{{ Str::words($item->name_geo, '5'); }}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="shop-item mb-20">
                            ...
                            <div class="shop-content text-center">
                                <h3 class="title"><a href="{{ route('product', $item->id) }}">{{ Str::words($item->name_eng, '5'); }}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="shop-item mb-20">
                            ...
                            <div class="shop-content text-center">
                                <h3 class="title"><a href="{{ route('product', $item->id) }}">{{ Str::words($item->name_rus, '5'); }}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endif
